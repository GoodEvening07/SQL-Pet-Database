...
CREATE TABLE `client` (
  ...
  CONSTRAINT `foreignKeyClient` FOREIGN KEY (`zipCode`) REFERENCES `citystatezip` (`zipCode`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `clientpet` (
  ...
  CONSTRAINT `fk_petId` FOREIGN KEY (`petId`) REFERENCES `pet` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `clientpet` VALUES (24,500),(8,502),(31,504),(30,505),(19,506),(12,507),(17,507),(5,508),(10,509),(27,510),(15,511),(25,511),(33,511),(13,512),(23,513),(26,514),(35,515),(16,516),(11,517),(6,518),(7,519),(2,520),(4,521),(2,523),(26,524),(29,525),(21,527),(14,529),(9,530),(3,531),(20,532),(15,533),(25,533),(33,533),(18,534),(28,534),(32,535),(2,536),(10,537),(32,538),(7,539),(24,540),(15,541),(25,541),(33,541),(15,543),(25,543),(33,543),(26,544),(30,545),(19,546),(12,547),(17,547),(32,548),(29,549);
...
CREATE TABLE `employee` (
  ...
  CONSTRAINT `fk_zipCode` FOREIGN KEY (`zipCode`) REFERENCES `citystatezip` (`zipCode`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `employeeposition` (
  ...
  CONSTRAINT `fk_employeeId` FOREIGN KEY (`employeeID`) REFERENCES `employee` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_positionId` FOREIGN KEY (`positionID`) REFERENCES `position` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pet` (
  ...
  PRIMARY KEY (`ID`),
  KEY `fk_breedId` (`breedId`),
  KEY `fk_petTypeId` (`petTypeId`),
  KEY `fk_colorId` (`colorId`),
  CONSTRAINT `fk_breedId` FOREIGN KEY (`breedId`) REFERENCES `breed` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_colorId` FOREIGN KEY (`colorId`) REFERENCES `color` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_petTypeId` FOREIGN KEY (`petTypeId`) REFERENCES `pettype` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2024-04-19 16:43:51
